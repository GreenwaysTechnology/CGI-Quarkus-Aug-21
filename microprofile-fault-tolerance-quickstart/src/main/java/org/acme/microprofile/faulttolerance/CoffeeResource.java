...
public class CoffeeResource {
    ...
    public List<Coffee> fallbakcoffeesList() {
        LOGGER.infof("Fallback");
    ...
    public Response cbFallback() {
        return Response.ok(new Random().nextInt(30) + " From fallback ").build();
    }
    ...
    //loadtest -n 100 -c 10 http://localhost:8080/coffee/bulk
    @GET
    @Path("/bulk")
    @Bulkhead(value = 5)
